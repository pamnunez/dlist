...
*/
    ...
    print_list(list2);
//    int delete;
//    printf("Trying to delete 0th...\n");
//    del(list2, 0, &delete);
//    print_list(list2);
//    printf("Delete 0th success!\n");
/*    printf("Trying to delete 3rd...\n");
    del(list2, 3, &delete);
    print_list(list2);
    printf("Delete 3rd success!\n");
    printf("Trying to delete 2nd...\n");
    del(list2, 2, &delete);
    print_list(list2);
    printf("Delete 2nd success!\n");
    ...
    print_list(list2);
    printf("delete = %d\n", delete);
    printf("Deleted 0th again!\n");
*/
    IntList* list4 = append1(list2, list3);
    printf("list3 = ");
    print_list(list3);
    printf("list2 = ");
    print_list(list2);
    ...
    printf("append2(list2, list3) = ");
    print_list(append2(list2, list3));
    printf("list2 = ");
    print_list(list2);
